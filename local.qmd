...
```{r plt-init-umap-density-penk-ctsl, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
...
```{r plt-init-umap-density-penk-glut, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Joint_Only(seurat_object = l6.srt, features = c("Penk", "Slc17a6"), custom_palette = l6.srt@misc$div_Colour_Pal)
```

```{r plt-init-umap-density-ctsl-glut, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
...
```{r plt-init-swne-density-wdr37-penk, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Joint_Only(
...
```{r plt-init-swne-density-wdr37-ctsl, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Joint_Only(
...
```{r plt-init-swne-density-penk-glut, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Joint_Only(
...
```{r plt-init-swne-density-ctsl-glut, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Joint_Only(
