...
Plot_Density_Custom(seurat_object = ca1.srt, features = c("Slc32a1"), custom_palette = l6.srt@misc$div_Colour_Pal)
```

```{r plt-ca1-swne-density-gad1, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Custom(seurat_object = ca1.srt, features = c("Gad1"), custom_palette = l6.srt@misc$div_Colour_Pal)
```

```{r plt-ca1-swne-density-gad2, fig.width = 12, fig.height = 14, fig.fullwidth = TRUE}
Plot_Density_Custom(seurat_object = ca1.srt, features = c("Gad2"), custom_palette = l6.srt@misc$div_Colour_Pal)
```
...
Plot_Density_Custom(seurat_object = ca1.srt, features = c("Slc17a6"), custom_palette = l6.srt@misc$div_Colour_Pal)
```
